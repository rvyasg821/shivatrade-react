...
const CountryList = () => {
  ...
  useEffect(() => {
    ...
    if (searchInput) {
      handler = setTimeout(() => {
        setCurrentPage(1);
        handleCountryLists(sort, sortColumn, 1, rowsPerPage, searchInput);
      }, 500);
    } else {
      handleCountryLists(sort, sortColumn, 1, rowsPerPage, searchInput);
    }
  ...
  useEffect(() => {
    ...
    if (store?.actionFlag === "CTRY_DELETED") {
      handleCountryLists();
    }
      ...
      <div className="main-content">
        ...
        <Card className="overflow-hidden">
          <CardBody>
            <Row>
              ...
              <Col sm="8" className="text-right">
                {permission?.can_create ? (
                  ...
                  >
                    {t("Add Country")} <PlusCircle size={16} />
                  </Button>
                ) : null}
              </Col>
            </Row>
            ...
            <Row className="mt-2">
              <Col md="12" className="country-table five-row-table">
                <DatatablePagination
                  columns={columns}

...
export const STEPS = [
  ...
  },
  {
    ...
    icon: Truck,
    fields: [
      "consignee_snapshot.name",
      "consignee_snapshot.address_line1",
      "consignee_snapshot.address_line2",
      "consignee_snapshot.city",
      "consignee_snapshot.state",
      "consignee_snapshot.postcode",
      "consignee_snapshot.country",
      "port_of_loading",
      "port_of_discharge",
      "final_destination",
      "country_of_origin",

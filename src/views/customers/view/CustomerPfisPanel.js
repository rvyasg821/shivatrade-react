// Customer detail page — PFIs list using the shared DatatablePagination
// wrapper, matching the main PFI listing page.
...
const CustomerPfisPanel = () => {
  ...
  const [sortColumn, setSortColumn] = useState("pfi_date");

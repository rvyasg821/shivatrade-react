export const API_ENDPOINTS = {
  ...
  uom: {
    ...
    deleteMany: `/admin/uom/delete-many`,
  ...
  priceList: {
    ...
    deleteMany: `/admin/price-list/delete-many`,
  ...
  reports: {
    ...
    leadToInvoiceDuration: `/admin/reports/lead-to-invoice-duration`,
    leadToInvoiceDurationExport: `/admin/reports/lead-to-invoice-duration/export`,
    advanceVsInvoice: `/admin/reports/advance-vs-invoice`,
    advanceVsInvoiceExport: `/admin/reports/advance-vs-invoice/export`,
    exchangeGainLoss: `/admin/reports/exchange-gain-loss`,
    exchangeGainLossExport: `/admin/reports/exchange-gain-loss/export`,
    salesOrderStatus: `/admin/reports/sales-order-status`,
    salesOrderStatusBreakdown: `/admin/reports/sales-order-status/breakdown`,
    salesOrderStatusLineBreakdown: `/admin/reports/sales-order-status/line-breakdown`,
    salesOrderStatusExport: `/admin/reports/sales-order-status/export`,
    purchaseOrderStatus: `/admin/reports/purchase-order-status`,
    purchaseOrderStatusBreakdown: `/admin/reports/purchase-order-status/breakdown`,
    purchaseOrderStatusLineBreakdown: `/admin/reports/purchase-order-status/line-breakdown`,
    purchaseOrderStatusExport: `/admin/reports/purchase-order-status/export`,
  ...
  inventory: {
    ...
    export: `/admin/inventory/export`, // closing-inventory Excel
  },
  invoices: {
  ...
  employees: {
    ...
    deleteMany: `/admin/employee/delete-many`,
  ...
  dropdown: {
    countries: `/admin/country/dropdown`,
    state: `/admin/state/dropdown`,
    city: `/admin/city/dropdown`,
  },
  booking: {
